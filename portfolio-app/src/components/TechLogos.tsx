...
const logos: Record<string, { svg: React.ReactNode; color: string }> = {
  ...
  HTML5: {
    color: '#E44D26',
    svg: (
      <path d="M3.5 2L5 20l7 4 7-4 1.5-18h-17zM12 19.5l-5.2-2.9-.4-4.6h2.6l.2 2.8L12 16l2.8-1.2.3-3.3H8.8l-.2-2.5h6.8l.2-2.5H8.2L8 4h8l-.3 3H9.5l.2 2.5h6.5l-.5 5.1L12 19.5z" fill="#E44D26" />
    ),
  },
  ...
  CSS3: {
    color: '#1572B6',
    svg: (
      <path d="M3.5 2L5 20l7 4 7-4 1.5-18h-17zM17.2 8l-.3 3.5L12 13l-4.5-1.5-.2-2.5h2.5l.1 1.2L12 11l2.1-.8.1-1.2H8l-.2-2.5h8.7L17.2 8z" fill="#1572B6" />
    ),
  },
  ...
  TailwindCSS: {
    color: '#06B6D4',
    svg: (
      <path d="M12 6c-2.67 0-4.33 1.33-5 4 1-1.33 2.17-1.83 3.5-1.5.76.19 1.3.73 1.91 1.34C13.44 10.88 14.55 12 17 12c2.67 0 4.33-1.33 5-4-1 1.33-2.17 1.83-3.5 1.5-.76-.19-1.3-.73-1.91-1.34C15.56 7.12 14.45 6 12 6zM7 12c-2.67 0-4.33 1.33-5 4 1-1.33 2.17-1.83 3.5-1.5.76.19 1.3.73 1.91 1.34C8.44 16.88 9.55 18 12 18c2.67 0 4.33-1.33 5-4-1 1.33-2.17 1.83-3.5 1.5-.76-.19-1.3-.73-1.91-1.34C10.56 13.12 9.45 12 7 12z" fill="#06B6D4" />
    ),
  },
  ...
  PostgreSQL: {
    ...
    svg: (
      <>
        ...
        <path d="M7 13c0 0 2 3 5 3s5-3 5-3" fill="none" stroke="white" strokeWidth="1.3" strokeLinecap="round" />
        <path d="M18 8c1-1.5 3-1 3 .5s-1.5 2-2.5 1.5" fill="#336791" stroke="#336791" strokeWidth="0.5" />
      </>
    ),
  },
  ...
  SQLite: {
    ...
    svg: (
      <>
        <path d="M4 8l8-4 8 4-8 4-8-4z" fill="#003B57" />
        <path d="M4 12l8 4 8-4" fill="none" stroke="#003B57" strokeWidth="2" />
        <path d="M4 16l8 4 8-4" fill="none" stroke="#003B57" strokeWidth="2" opacity="0.5" />
      </>
    ),
  },
  ...
  Linux: {
    ...
    svg: (
      <>
        <ellipse cx="12" cy="13" rx="6" ry="8" fill="#666" />
        ...
        <path d="M10 14c.8 1 3.2 1 4 0" fill="none" stroke="#f59e0b" strokeWidth="1.2" strokeLinecap="round" />
        <ellipse cx="8" cy="6" rx="1.5" ry="2" fill="#666" />
        <ellipse cx="16" cy="6" rx="1.5" ry="2" fill="#666" />
      </>
    ),
  },
}

export function TechLogo({ name, size = 24 }: { name: string; size?: number }) {
  const logo = logos[name]
  if (!logo) {
    return (
      <div className="rounded flex-shrink-0 flex items-center justify-center font-bold"
        style={{ width: size, height: size, background: 'var(--surface-highlight)', color: 'var(--text-2)', fontSize: size * 0.4 }}>
        {name.charAt(0)}
      </div>
    )
  }
